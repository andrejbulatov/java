...
// и возведения первого числа в степень второго числа. Если введены некорректные числа или происходит деление на ноль, 
...
// Если введены некорректные числа или происходит ошибка ввода, соответствующие исключения перехватываются и выводится информативное сообщение 
// об ошибке.
...
public class App {
    public static void main(String[] args) throws Exception {
        /**
         * Создаю новый калькулятор, view и запускаю запрос сведений и расчет арифметических операций
         */
        Calculator calculator = new Calculator();
        PowerCalculator pCalculator = new PowerCalculator();
        ViewCalculator view = new ViewCalculator(calculator, pCalculator);
        view.run();
    }
}
